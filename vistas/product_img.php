   ...
   ?>
      ...
      <div class="columns">
         <div class="column is-two-fifths">
            <?php if (is_file("img/producto/" . $datos['foto_producto'])) { ?>

               <figure class="image mb-6">
                  <img src="img/producto/<?php echo $datos['foto_producto']; ?>">
               </figure>
         ...
         <div class="column">
            <form class="mb-6 has-text-centered FormularioAjax" action="php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off">
               ...
               <h4 class="title is-4 mb-6"><?php echo $datos['nombre_producto']; ?></h4>
